...
describe("Tools Hub wording", () => {
  ...
  it("does not advertise the AI and market screens that were removed for showing invented figures", () => {
    // Their cards used to sit here (experimental, "not live market data"). The screens
    // are gone, so a card for them would be an empty box that leads nowhere.
    for (const removed of ["AI Insights", "Market Views", "Market Intelligence", "Market Trends", "Pricing Brain", "AI Price Estimator"]) {
